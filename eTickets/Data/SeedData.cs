...
namespace eTickets.Data
{
    public class SeedData
    {
        ...
        {
            using (var context = new eTicketsContext(serviceProvider.GetRequiredService<DbContextOptions<eTicketsContext>>()))
            {
